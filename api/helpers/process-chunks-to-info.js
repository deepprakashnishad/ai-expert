module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    for(let i=0;i < inputs.chunks.length; i++){
      ...
      var mPrompt = `Breakdown the text enclosed in triple hash in small text into logical section without loosing, ignoring and skipping any information ###${chunk}###. Output must be JSON ARRAY only and must contain every peice of information given in triple hash.`;
